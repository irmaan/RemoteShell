<?php
	...
	define('VERSION', '0.13');
	define('REALM_NAME', 'RemoteShell ' . VERSION);
	...
	check_auth('remoteshell', 'iRmaAn2015');
...
<html>
	...
	<body>
		...
		<table id="display">
			<tr style="height:40px;"><td style="line-height:40px;font-weight:bold;"><!-- REMOTE SHELL INFO -->
				REMOTE SHELL <?php echo(VERSION); ?>
